...
|---|---|
|iPhone 17 Pro Max|79,5|
|iPhone 17|77,6|
|Samsung Galaxy S25 Ultra|76,9|
|Google Pixel 7|76,6|
|Huawei Novo 15 Pro|75,2|
|iPhone 13 Pro Max|74,1|
|Xiaomi Redmi Note 13 Pro|70,4|
|MSI Thin 15 B12UC|67,8|
|Xiaomi Redmi Note 7|65,8|
|Realme C51|65,4|
|MacBook M4 Pro|64,3|
|Asus TUF F17|60,7|
|Samsung A55|58,5|
...
![Результат оценки](leaderboard.png)
...
В качестве основного варианта в рамках дисциплины используется SPAQ. Выбор обусловлен тем, что это датасет составленный из фотографий на смартфоны, включающий в себя определенные размеченные параметры (brightness, colorfulness, contrast, noisiness, sharpness).
